...
const ShippingAddress = () => {
    ...
    useEffect(() => {
        if(shippingAddressStatus && shippingAddress) {
    ...
    }, [dispatch, shippingAddress, shippingAddressStatus])
  ...
  return (
    <SafeAreaView style={tw('flex-1')}>
      ...
      style={tw('flex-1')}>
        ...
        <Text style={tw('text-2xl font-bold text-zinc-700')}>Enter a Shipping Address</Text>
        ...
        <ScrollView 
            ...
            <TextInput placeholder='ZipCode' keyboardType='numeric' style={tw('w-full rounded-md border border-gray-300 text-zinc-700 font-bold text-lg py-2 px-4 bg-gray-200 mb-4')} value={zipCode} onChangeText={(text ) => setZipCode(text)} onSubmitEditing={submitShippingAddress}></TextInput>

            <Button onPress={submitShippingAddress} titleStyle={tw('text-zinc-700  text-lg')} title="Proceed to Biling Address" buttonStyle={tw('w-full font-bold text-black text-lg bg-amber-300 rounded-lg py-4 my-4')}></Button>
            </ScrollView>

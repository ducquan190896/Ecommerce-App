...
import { getOrdersByAuth, getOrdersByIdByAuth, resetOrder } from '../Reducers/Actions/OrderAction'
        ...
        <TouchableWithoutFeedback style={tw('flex-1')} onPress={Keyboard.dismiss}>
            <View style={tw('flex-1')}>
                <View style={tw('w-full relative py-2 items-center justify-center bg-[#22e3dd]')}>     
                    <Text style={tw('text-3xl font-bold text-zinc-700')}>Orders</Text>
...
export default OrdersScreenOfUser
